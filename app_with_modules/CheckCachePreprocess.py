...
if os.path.isfile('Database/database.sqlite'):
    ...
    # Merge result tables in two (long: lon/lat/time, and short: lon/lat) and make them ready to be uploaded to the db
    ...
    c = conn.cursor()
    # First table: Temporal table (long)
    ...
    # Second table table: Fixed table (long)
    ...
    conn.commit() # End connection to database
